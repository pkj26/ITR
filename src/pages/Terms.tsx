...
export default function Terms() {
  return (
    <main className="flex-grow bg-white py-16">
      <SEO title="Terms & Conditions | Online ITR Filing" url="https://taxserve.in/#/terms-conditions" />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate max-w-none">
        ...
        <p>You agree to provide true, accurate, current, and complete information as required for providing our services. You are responsible for maintaining the confidentiality of any login credentials.</p>
